#' @title Pre Nucleolus simplex
#' @description  Linear programming algorithm for computing the pre nucleolus.
...
#' @seealso \link{Excesses}, \link{Nucleolus}, \link{PreNucleolus}
#' @export

PreNucleolussimplex=function(v,C,b,Ceq,beq){
